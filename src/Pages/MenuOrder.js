        ...
        <div className='subContainer'>
            ...
            <div className="nav">
                ...
                <div className="dropdown">
                    ...
                    >
                        <option value="all" onClick={() => handleButtonClick('all')}>All</option>
                        <option value="recommends" onClick={() => handleButtonClick('recommends')}>Recommends</option>
                        <option value="specials" onClick={() => handleButtonClick('specials')}>Specials</option>
                        <option value="bestSeller" onClick={() => handleButtonClick('bestSeller')}>Best Seller</option>
                    </select>
                </div>
          ...
          <div className='payBtn'>
            ...
            {showCart && (
          <div className={`cart2 ${showCart ? 'cart-visible' : ''}`}>
          <div className='cartTitle'>
              <h2>Your Cart</h2>
          </div>
          <div className='cartItems'>
